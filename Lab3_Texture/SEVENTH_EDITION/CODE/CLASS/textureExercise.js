...
window.onload = function init( ) {
	...
	//-------------------------------------------------------------------------------------- Block 1
	// // TODO1 - After running the program once, adjust texCoords above to wrap multiple copies of the 
	// //         texture onto the polygon.  Try different repetitions, including some fractional ones.
	// // TODO2 - change the texData array from 2 x 2 = 4 pixels to 4 x 4 = 16 pixels
	...
	// 								2,   0, 255, 255,
	// 								85,   0, 255, 255,
	// 								3,   0, 255, 255 ] ); // red, green, blue, gray ,
	...
	// // TODO3 - Activate this block instead of block 1.  Report what you get.
	// // TODO4 - Modify the polygon dimensions to be a rectangle twice as wide as it is tall.	
	...
	// TODO5 - Make this the active block, and try it in different web browsers.
	//         If it works anywhere, continue to TODO6.  Otherwise try to get it working.
	// TODO6 - Change the source image in the HTML file to use bricks.jpg.  What happens?
	// TODO7 - Change the source to bricksSquare.jpg.  Adjust vertex positions and texCoords
	//         to make a nice looking "wall" of some length.  ( Might need to adjust lookAt. )

	var image = new Image(  );
	//image.crossOrigin = "";
	//image.src = "bricksSquare.jpg";  //Loadingfiledirectly
...
function render( ) {
	...
	var modelView = lookAt( vec3( 1.5, 1.5, 1.5 ), vec3( 1, 0, 0 ), vec3( 0, 1, 0 ) );
